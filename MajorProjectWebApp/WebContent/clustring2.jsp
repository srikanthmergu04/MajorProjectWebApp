...
<div class="wrapper">
  ...
  <center><h2 style="font-size: 26px; color:  darkgoldenrod; font-family: Copperplate Gothic Bold">grouping objects </h2></center>
      ...
      <center>
          <table>
           <%
                        ...
                        String caption =request.getParameter("object");
                        session.setAttribute("object", caption);
                       Connection con = DbConnection.getConnection();
                        Statement st = con.createStatement();
                        ResultSet rs = st.executeQuery("select * from documentup  where catego = '"+caption+"' group by caption");
                    ...
                    %>
                  <tr><td><center><a style="color:red;font-size: 30px"href="viewmap2.jsp?cate=<%=catee%>"><%=catee%></a></center></td><td><center><a href="clustering3.jsp?caption=<%=captione%>"><%=captione%></a></center></td></tr>
