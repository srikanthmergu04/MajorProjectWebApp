...
<div class="wrapper">
  ...
  <center><h2 style="font-size: 26px; color:  darkgoldenrod; font-family: Copperplate Gothic Bold">USER LOGIN</h2></center>
  <div class="page-wrapper" style="border-style:   dotted; border-width: 5px;border-color: cadetblue;">
  	...
  	<div style="float: left; margin-left: 10px;background:   burlywood">
                    ...
                    <br><form action="login.jsp" method="post"> 
                        <label STYLE="font-size: 25px">USERNAME</label><input type="text" class="inputs" name="name" required="" placeholder="USERNAME" /><BR>
                        <label STYLE="font-size: 25px">PASSWORD</label><input type="password" class="inputs" name="pass" required="" placeholder="PASSWORD" /><br> 
                        
                        <br><input type="hidden" value="1" name="status" />
                        <input type="Submit" value="LOGIN" class="button" >
                        <input type="reset" value="Reset" class="button" >
                    </form></center>
                    </div>
          <div style="float: right; margin-left: 10px;background: blanchedalmond">
              <img style="width:580px;height: 300px"src="images\login.jpg"></img>
          </div>
      </div>
  </div>
