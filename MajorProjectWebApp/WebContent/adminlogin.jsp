...
<div class="wrapper">
  ...
  <center><h2 style="font-size: 26px; color:  darkgoldenrod; font-family: Copperplate Gothic Bold">ADMIN LOGIN</h2></center>
  <div class="page-wrapper" style="border-style: dotted; border-width: 5px;border-color: cadetblue;">
  	...
  	<div style="float: left; margin-left: 10px;background:   burlywood">
          ...
          <div style="float: right; margin-left: 10px;background: blanchedalmond">
              <img style="width:580px;height: 300px"src="images\admin.png"></img>
          </div>
      </div>
  </div>
