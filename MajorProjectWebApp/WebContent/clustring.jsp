...
<div class="wrapper">
  ...
  <center><h2 style="font-size: 26px; color:  darkgoldenrod; font-family: Copperplate Gothic Bold">OBJECT</h2></center>
      ...
      <center>
           <%
                       ...
                       Connection con = DbConnection.getConnection();
                        ...
                        ResultSet rs = st.executeQuery("select * from documentup  group by catego");
                      
                       
                            
                        while (rs.next()) {
                           String cate=rs.getString("catego").toUpperCase();
                  ...
                  <center><a href="clustring2.jsp?object=<%=cate%>"><%=cate%></a></center>
